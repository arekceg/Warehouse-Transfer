...
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (7, 10, 'AVAILABLE', 2, 2);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (8, 0, 'RESERVED', 1, 1);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (9, 0, 'RESERVED', 1, 2);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (10, 0, 'RESERVED', 2, 2);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (11, 10, 'AVAILABLE', 2, 3);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (12, 0, 'RESERVED', 1, 3);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (13, 0, 'RESERVED', 3, 3);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (14, 50, 'AVAILABLE', 3, 4);
INSERT INTO `warehouse-management-TESTING`.stocks (id, itemStock, stockType, item_id, warehouse_id) VALUES (15, 100, 'AVAILABLE', 4, 4);
